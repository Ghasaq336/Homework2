...
yes, because we at buzzfeed we analyze the data to be able to search for more understanding of the data to get information frome it, so we create a lot of filters to understand the data better and deeper. 
